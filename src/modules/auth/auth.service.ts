...
<body>
    <div class="container">
        ...
        <p>Hello, User</p>
        <p>You've requested to reset your password for your ScanMenu account. Click the link below to set a new password:</p>
        <a href="${resetUrl}" class="button" style="color: white; text-decoration: none;">Reset My Password</a>
        <p>If you didn't request this, please ignore this email.</p>
        <p class="footer">© 2024 ScanMenu. All rights reserved.</p>
    </div>
</body>
</html>
  `;
