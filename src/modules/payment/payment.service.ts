...
import { createTokenDto } from '../usertoken/dto/create-token.entity';
@Injectable()
export class PaymentService {
  constructor(
    ...
    private userTokenServie: UsertokenService,
  ...
  async changePayment(userId: string, token: string) {
    ...
    try {
      ...
      // Update token
      this.CreateTokenDto.amount = payment.amount;
      await this.userTokenServie.addTokens(userId, this.CreateTokenDto);
